...
module.exports = generator.extend({
  ...
  writing: function () {
    ...
    var fullpathToActivityPackage = 'app/src/main/java/' + packageDir + '/features/' + sufixPackageDir;
      ...
      //src folder
      this.fs.copyTpl(this.templatePath('fragment_mvp/src/MvpFragComponent.java'),
    ...
    try {
      let act1 = 'import '+this.props.appPackage + '.features' + this.props.fragmentPackageName + '.' + justName + 'Component;';
      let act2 = 'import ' +this.props.appPackage +'.features' + this.props.fragmentPackageName + '.' + justName + 'PresenterModule;';
